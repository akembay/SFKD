#  SFKD: Efficient Knowledge Distillation via Salient Feature Masking

This repository provides the official reference implementation of SFKD integrated with DKD (Decoupled Knowledge Distillation).
...
This codebase is heavily borrowed from [Logit Standardization in Knowledge Distillation (CVPR 2024)](https://github.com/sunshangquan/logit-standardization-KD) and [Knowledge Distillation with Refined Logits (ICCV 2025)](https://github.com/zju-SWJ/RLD). Sincere gratitude to the authors for their distinguished efforts. 
